...
<nav class="bg-gray-500 border-gray-200">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div>
      ...
      <div class="w-full md:block md:w-auto" id="navbar-dropdown" class:hidden={!state.isOpen}>
          ...
          <li class="hidden lg:block md:block relative">
            <a href="/cart">
              <div class="t-0 absolute left-3 -top-4">
                <p class="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-3 text-xs-white text-white">0</p>
              </div>
